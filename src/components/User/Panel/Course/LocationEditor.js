...
export default function LocationEditor(props){
  const classes = useStyles();
  const { sess, token, setCSRFToken, isSupportWebp, handleSnackBar, setPageState, edittingField, setEdittingField, pageOrganizer, pageData } = props
  ...
  return(
    <div className={classes.root}>
      ...
      <div className={classes.flexGrid}>
        <TextField
          fullWidth
          label={ ( sess && sess.language === 'TH' ) ? "ชื่อสนาม" : 'Location name' }
