...
const OrganizerNewsCard = Loadable({
  loader: () => import(/* webpackChunkName: "OrganizerNewsCard" */ './OrganizerNewsCard'),
  loading: () => null
});
...
export default function OrganizerNews(props) {
    ...
    const d = [
      {
        ...
        picture: 'https://pga-tour-res.cloudinary.com/image/upload/c_fill,dpr_1.5,f_auto,g_center,h_478,q_auto,w_850/v1/pgatour/editorial/2019/08/26/mcilroymondayfinish-847-kevinccox.jpg'
      },
      {
        id: 2,
        ...
        picture: 'https://pga-tour-res.cloudinary.com/image/upload/c_fill,dpr_1.5,f_auto,g_center,h_478,q_auto,w_850/v1/pgatour/editorial/2019/08/26/Finau-Driver-847-Getty.jpg'
      },
      {
        id: 3,
        ...
        picture: 'https://pga-tour-res.cloudinary.com/image/upload/c_fill,dpr_1.5,f_auto,g_face:center,h_478,q_auto,w_850/v1/pgatour/editorial/2019/06/24/genericball-847-getty.jpg'
      },
      {
        id: 4,
        ...
        picture: 'https://pga-tour-res.cloudinary.com/image/upload/c_fill,dpr_1.5,f_auto,g_center,h_478,q_auto,w_850/v1/pgatour/editorial/2019/08/25/Weather-EastLake-847-PGATOUR.jpg'
      },
      {
        id: 5,
        ...
        picture: 'https://pga-tour-res.cloudinary.com/image/upload/c_fill,dpr_1.5,f_auto,g_center,h_478,q_auto,w_850/v1/pgatour/editorial/2019/08/24/htwrd4-847-pgatour.jpg'
      },
    ]
    setData(d)
  }
  ...
  return(
    <div className={classes.root}>
      ...
      <div className={classes.grid}>
        { data?
          data.map( d => <OrganizerNewsCard key={d.newsid} {...props} data={d}/> )
          :
          Array.from(new Array(3)).map((d, i) => <OrganizerNewsCard key={i} loading/>)
        }
      </div>
